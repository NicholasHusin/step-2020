...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void availableOptionalAttendee() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
          Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  @Test
  public void onlyAvailableOptionalAttendee() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
          Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  @Test
  public void addAsMuchOptionalAttendee() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
          Arrays.asList(PERSON_A)),
  ...
  @Test
  public void optionalAttendeeDoesNotOvertakeMandatoryAttendee() {
    // If a mandatory attendee could not make a certain time
    // that time shouldn't be included on the list of possible meeting times
    // even if that particular time would have more attendance from optional attendees.
    Collection<Event> events = Arrays.asList(
  ...
  @Test
  public void optionalAttendeePriority() {
    // If there are multiple time ranges where we'd have the same amount of optional attendees
    // but the optional attendees will be different, the earlier optional attendee is given priority.
    //
    // Ex:
    // If optional attendees are: A B C in order, then the priority goes as
    // A > B > C
    Collection<Event> events = Arrays.asList(
    ...
    MeetingRequest request = new MeetingRequest(Arrays.asList(PERSON_D), DURATION_30_MINUTES);
